...
namespace Jcd.Utilities.Generators
{
    public class ByteSequenceGenerator : Generator<ByteSequenceState, Byte>
    {
        ...
        public ByteSequenceGenerator(ByteSequenceState initialState, StateTransitionFunction stateTransition) : base(initialState, stateTransition)
        {
        }
    }
    ...
    public class UInt16SequenceGenerator : Generator<UInt16SequenceState, UInt16>
    {
        ...
        public UInt16SequenceGenerator(UInt16SequenceState initialState, StateTransitionFunction stateTransition) : base(initialState, stateTransition)
        {
        }
    }
    ...
    public class UInt32SequenceGenerator : Generator<UInt32SequenceState, UInt32>
    {
        ...
        public UInt32SequenceGenerator(UInt32SequenceState initialState, StateTransitionFunction stateTransition) : base(initialState, stateTransition)
        {
        }
    }
    ...
    public class UInt64SequenceGenerator : Generator<UInt64SequenceState, UInt64>
    {
        ...
        public UInt64SequenceGenerator(UInt64SequenceState initialState, StateTransitionFunction stateTransition) : base(initialState, stateTransition)
        {
        }
    }
    ...
    public class SByteSequenceGenerator : Generator<SByteSequenceState, SByte>
    {
        ...
        public SByteSequenceGenerator(SByteSequenceState initialState, StateTransitionFunction stateTransition) : base(initialState, stateTransition)
        {
        }
    }
    ...
    public class Int16SequenceGenerator : Generator<Int16SequenceState, Int16>
    {
        ...
        public Int16SequenceGenerator(Int16SequenceState initialState, StateTransitionFunction stateTransition) : base(initialState, stateTransition)
        {
        }
    }
    ...
    public class Int32SequenceGenerator : Generator<Int32SequenceState, Int32>
    {
        ...
        public Int32SequenceGenerator(Int32SequenceState initialState, StateTransitionFunction stateTransition) : base(initialState, stateTransition)
        {
        }
    }
    ...
    public class Int64SequenceGenerator : Generator<Int64SequenceState, Int64>
    {
        ...
        public Int64SequenceGenerator(Int64SequenceState initialState, StateTransitionFunction stateTransition) : base(initialState, stateTransition)
        {
        }
    }
    ...
    public class BigIntegerSequenceGenerator : Generator<BigIntegerSequenceState, BigInteger>
    {
        ...
        public BigIntegerSequenceGenerator(BigIntegerSequenceState initialState, StateTransitionFunction stateTransition) : base(initialState, stateTransition)
        {
        }
    }
}
