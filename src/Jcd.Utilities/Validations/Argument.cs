...
namespace Jcd.Utilities.Validations
{
    public static class Argument
    {
        ...
        {
            IsNotNull(list, name);
            Check.IsEmpty(list, onFailure: () => RaiseArgumentException(name, message ?? $"Expected {name} to be an empty collection, but it contained values."));
        }

        public static void HasItems<T>(IEnumerable<T> list, string name = null, string message = null)
        {
            IsNotNull(list, name);
            Check.HasItems(list, onFailure: () => RaiseArgumentException(name, message ?? $"Expected {name} to contain at least one item, but it was empty."));
        }
        ...
        {
            IsNotNull(list, name);
            Check.DoesNotContain(list, target, onFailure: () => RaiseArgumentException(name, message ?? $"{target} was expected to not be in {name}, but was found."));
        }
        #endregion
        ...
        public static void IsEmpty(string value, string name = null, string message = null)
        {
            ...
            Check.IsEmpty(value, onFailure: () => RaiseArgumentException(name, message ?? $"Expected {name} to be an empty string, but it contains text."));
        }
        public static void HasData(string value, string name = null, string message = null)
        {
            IsNotNull(value, name);
            Check.HasData(value, onFailure: () => RaiseArgumentException(name, message ?? $"Expected {name} to be a non-empty string, but it contains text."));
        }
        ...
        {
            IsNotNull(value, name);
            Check.PassesAny(new Check.Signature<string>[] { Check.IsWhitespace, Check.IsEmpty }, value, onFailure: ()=> RaiseArgumentException(name, message ?? $"Expected {name} to be whitespace or empty."));
        }
        public static void IsNullOrWhitespace(string value, string name = null, string message = null)
        {
            Check.PassesAny(new Check.Signature<string>[] { Check.IsNull, Check.IsWhitespace }, value, onFailure: () => RaiseArgumentException(name, message ?? $"Expected {name} to be null or whitespace"));
        }
        public static void IsNullWhitespaceOrEmpty(string value, string name = null, string message = null)
        {
            Check.PassesAny(new Check.Signature<string>[] { Check.IsNull, Check.IsWhitespace, Check.IsEmpty }, value, onFailure: () => RaiseArgumentException(name, message ?? $"Expected {name} to be null, whitespace, or empty"));
        }

        public static void IsNullOrEmpty(string value, string name = null, string message = null)
        {
            Check.PassesAny(new Check.Signature<string>[] { Check.IsNull, Check.IsEmpty }, value, onFailure: () => RaiseArgumentException(name, message ?? $"Expected {name} to be null or empty"));
        }

        public static void IsNotWhitespace(string value, string name = null, string message = null)
        {
            Check.IsNotWhitespace(value, onFailure: () => RaiseArgumentException(name, message ?? $"Invalid argument: {name} is all whitespace."));
        }
        public static void IsNotWhitespaceOrEmpty(string value, string name = null, string message = null)
        {
            Check.FailsAll(new Check.Signature<string>[] { Check.IsWhitespace, Check.IsEmpty }, value, onFailure: () => RaiseArgumentException(name, message ?? $"Expected {name} to be non-empty and non-whitespace."));
        }
        public static void IsNotNullOrWhitespace(string value, string name = null, string message = null)
        {
            Check.FailsAll(new Check.Signature<string>[] { Check.IsNull, Check.IsWhitespace }, value, onFailure: () => RaiseArgumentException(name, message ?? $"Expected {name} to be null, empty, or whitespace."));
        }
        public static void IsNotNullWhitespaceOrEmpty(string value, string name = null, string message = null)
        {
            Check.FailsAll(new Check.Signature<string>[] { Check.IsNull, Check.IsEmpty, Check.IsWhitespace }, value, onFailure: () => RaiseArgumentException(name, message ?? $"Expected {name} to be non-null, non-empty, and non-whitespace."));
        }
        public static void IsNotNullOrEmpty(string value, string name = null, string message = null)
        {
            Check.FailsAll(new Check.Signature<string>[] { Check.IsNull, Check.IsEmpty }, value, onFailure: () => RaiseArgumentException(name, message ?? $"Expected {name} to be non-null and non-empty."));
        }
        #endregion
        ...
        {
            Check.AreSameObject(value, comparison, onFailure: () => RaiseArgumentException(name, message ?? $"Object for {name} was not the expected instance."));
        }
